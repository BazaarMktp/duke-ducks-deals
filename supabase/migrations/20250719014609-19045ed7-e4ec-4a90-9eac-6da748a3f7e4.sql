-- Fix the search path security issue for find_similar_listings_by_embedding function
CREATE OR REPLACE FUNCTION public.find_similar_listings_by_embedding(
