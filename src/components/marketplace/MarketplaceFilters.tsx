...
const MarketplaceFilters = ({ 
  ...
  return (
    <div className="space-y-2 sticky top-[calc(2.75rem+env(safe-area-inset-top,0px))] sm:top-[calc(3rem+env(safe-area-inset-top,0px))] lg:top-14 z-40 bg-background pb-1 -mx-2 px-2 sm:-mx-3 sm:px-3 lg:-mx-4 lg:px-4">
      {/* Search bar */}
